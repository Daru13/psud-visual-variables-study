...
for sat in tqdm(sat_domain):
    ...
    for lum_1 in lum_1_domain:
        ...
        for lum_2 in lum_2_domain:
            ...
            distance = np.square(delta_e_cie2000(desaturated_lab_color_1, desaturated_lab_color_2)) + np.square(delta_e_cie2000(desaturated_lab_color_1, lab_color_1)) + np.square(delta_e_cie2000(desaturated_lab_color_2, lab_color_2))
